                    ...
                    <form id="registerForm" class="w-full mt-10 space-y-10">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="inputField">
                                ...
                                <input id="formStudentID" type="text" name="student_id" class="inputBox" required>
                            </div>

                            <div class="inputField">
                                <label for="year_level">Year Level: </label>
                                <select id="formYearLevel" class="border border-black px-3 py-2 w-1/5" name="year_level" required>
