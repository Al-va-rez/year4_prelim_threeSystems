...
class Subcategories extends Database {
    public function createSubcategory($main_category_id, $subcategory_title) {
        $sql = "INSERT INTO subcategories (main_category_id, subcategory_title) VALUES (?, ?)";
        return $this->executeNonQuery($sql, [$main_category_id, $subcategory_title]);
    }
