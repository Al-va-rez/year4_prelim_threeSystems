...
<!doctype html>
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="display-4 text-center">Showing all proposals in the subcategory: <span class="text-success"><?= $_GET['subCat'] ?></span></div>
      ...
      <div class="row justify-content-center">
        <div class="col-md-12" id="mainProposalContainer">
          <?php $getProposals = $proposalObj->getProposalsBySubcategory($_GET['subCat']); ?>
                ...
                <div class="col-md-6">
                  <div class="card" style="height: 600px;">
                    ...
                    <div class="card-body overflow-auto">
                      ...
                      <div class="offer">
                        <h4><?php echo $offer['username']; ?> <span class="text-primary">(<?= $offer['contact_number'] ?>)</span></h4>
                    ...
                    <div class="card-footer">
                      <form class="sendOfferForm">
                        <div class="form-group">
                          <label for="#">Description</label>
                          <input type="text" class="form-control offerDesc" name="description">
                          <input type="hidden" class="form-control proposal_id" name="proposal_id" value="<?php echo $proposal['proposal_id']; ?>">
    ...
    <script>
      ...
      $(document).on('submit', '.sendOfferForm', 
        function (event) {
          event.preventDefault();

          var formData = {
            proposal_id: $(this).find('.proposal_id').val(),
            offerDesc: $(this).find('.offerDesc').val(),
            insertOfferBtn: 1
          };
          ...
          $.ajax(
            {
              ...
              success: function(data) {
                ...
                switch (data) {
                  ...
                  case 'Cannot submit another offer':
                    alert(data);
                    break;
