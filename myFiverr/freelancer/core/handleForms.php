...
if (isset($_POST['insertNewProposalBtn'])) {
	...
	$main_category_title = htmlspecialchars($_POST['category_title']);
	...
	if (move_uploaded_file($tempFileName, $folder)) {
		if ($proposalObj->createProposal($user_id, $main_category_title, $subcategory_title,  $description, $imageName, $min_price, $max_price)) {
			$_SESSION['status'] = "200";
...
if (isset($_POST['filterReq'])) {
	$category_title = $_POST['main_category_title'];

	$result = $subcategoryObj->getSubcategories($category_title);
