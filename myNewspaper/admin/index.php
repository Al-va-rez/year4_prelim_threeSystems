...
<!doctype html>
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="display-4 text-center">Hello there and welcome to the admin side! <span style="color: #F9C70C;"><?php echo $_SESSION['username']; ?></span>. Here are all the articles</div>
        ...
        <div class="col-md-6">
          ...
          <div class="card mt-4 shadow">
            ...
            <div class="card-body">
              ...
              <h2><?php echo $article['category_title']; ?></h2> 
              ...
              <form class="deleteArticleForm">
                ...
                <input type="submit" class="btn btn-danger float-right mb-4 deleteArticleBtn" value="Delete" name="deleteArticleBtn">
              </form>
              ...
              <?php if ($article['author_id'] != $_SESSION['user_id']): ?>
                <form action="core/handleForms.php" method="POST" class="requestEditAccessForm">
                  ...
                  <input type="submit" class="btn btn-secondary float-right mb-4 mr-2 requestEditAccessBtn" value="Request Edit Access" name="requestEditAccessBtn">
                </form>
              <?php endif ?>
            </div>
          </div>  
