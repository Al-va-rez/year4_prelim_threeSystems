...
<!doctype html>
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark p-4 shadow-sm" style="background-color: #6796e2ff;">
      <div class="container">
        <a class="navbar-brand font-weight-bold" href="#">School Publication Homepage</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link text-white" href="writer/index.php">Writer</a></li>
          </ul>
        </div>
      </div>
    </nav>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card shadow">
            <div class="card-header" style="background-color: #baccffff;"><h1>Writer</h1></div>
            <div class="card-body">
        ...
        <div class="col-md-6">
          <div class="card shadow">
            <div class="card-header" style="background-color: #baccffff;"><h1>Admin</h1></div>
            <div class="card-body">
